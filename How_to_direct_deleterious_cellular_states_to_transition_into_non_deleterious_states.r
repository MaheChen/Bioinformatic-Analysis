...
```{r, echo=FALSE, fig.width=12, fig.height=5}
h1 <- drug1_dose5_t4 %>% ggplot(aes(x = NGFR)) + geom_histogram()
h2 <- drug1_dose5_t4 %>% ggplot(aes(x = MiTFg)) + geom_histogram()
h3 <- drug1_dose5_t4 %>% ggplot(aes(x = AXL)) + geom_histogram()
h4 <- drug1_dose5_t4 %>% ggplot(aes(x = Sox10)) + geom_histogram()
